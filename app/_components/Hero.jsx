  ...
  >
    <div className="max-w-xl  ltr:sm:text-left rtl:sm:text-right ">
      ...
      <div className="mt-8 flex  gap-4 text-center">
        <a
          href="#start"
          className="block w-full rounded bg-[#6930c3] px-12 py-3 text-sm font-medium text-white shadow hover:bg-[#6930c3] focus:outline-none focus:ring active:bg-primary sm:w-auto max-sm:px-3"
        >
          Get Started
        </a>
        ...
        <a
          href="#work"
          className="block w-full rounded bg-white px-12 py-3 text-sm font-medium text-[#6930c3] shadow hover:text-[#6930c3] focus:outline-none focus:ring active:text-primary sm:w-auto max-sm:px-3"
        >
          Learn More
        </a>
      </div>
