...
<ul className='my-7'>
    ...
    <li className='flex py-2 space-x-6 '><MessageSquareText className='mr-2 h-5 w-5 max-sm:w-6'/>Our AI engine curates top freight forwarders,select them and start chatting.</li>
