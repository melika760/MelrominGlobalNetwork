...
const Getstarted = () => {
  ...
  <div className="mx-auto max-w-screen-xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8 lg:py-16">
    <div className="mx-auto max-w-lg text-center">
      <h2 className="text-3xl font-bold sm:text-4xl text-blue-950">How it Works?</h2>
    </div>

    <div className="mt-8 grid md:grid-cols-2 grid-cols-1 md:gap-20 gap-10">
    <div className='border shadow-sm bg-secondary md:py-20 py-10 md:px-20 px-5 rounded-md'>
