...
const Getstarted = () => {
  ...
  <div className="mx-auto max-w-screen-xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8 lg:py-16">
    <div className="mx-auto max-w-lg text-center">
      <h2 className="text-3xl font-extrabold sm:text-4xl  bg-gradient-to-r from-blue-900  to-blue-500 bg-clip-text text-transparent ">Get Started</h2>
    </div>
...
<ul className='my-7'>
    ...
    <li className='flex py-2'><ScrollText className='mr-2 h-5 w-5 max-sm:w-5'/>Seal the deal and arrange payment right here </li>
</ul>
