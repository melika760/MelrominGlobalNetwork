  ...
  return (
    ...
    <div className="mx-auto max-w-5xl px-4 py-16 sm:px-6 lg:px-8">
      ...
      <ul className="mt-6 grid grid-cols-1 lg:grid-cols-3 lg:justify-items-center lg:text-center gap-4 md:gap-8">
        ...
        <li>
          <span className='text-lg font-semibold flex  max-sm:text-md '><MailOpen className='mr-2 max-sm:w-4 text-primary animate-custom-bounce '/><strong className=' bg-gradient-to-r from-blue-900  to-blue-500 bg-clip-text text-transparent'>Email:</strong></span>rostam@melromin.co.uk
        </li>
