...
const Icons = () => {
  ...
  return (
    <div className='mt-9 grid grid-cols-3 gap-4'>
        ...
        <div className=' bg-[#6930c3] w-[70px] rounded-full h-[70px] max-sm:w-[60px] max-sm:h-[60px] items-center flex flex-col justify-center border-[#6930c3] border-2  hover:scale-105  shadow'>
        <item.Icon size={32} color="#ffff" strokeWidth={1.5} />
        
        </div>
        <h2 className='text-gray-800 font-bold max-sm:text-md'>{item.Tiltle}</h2>
      </div>))}
