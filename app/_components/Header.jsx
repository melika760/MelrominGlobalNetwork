...
<div className='flex items-center justify-between p-4 shadow-sm'>
  ...
  <Link href={"/sign-in"}><Button variant={"ghost"} className="sm:text-sm  bg-gradient-to-r from-blue-900  to-blue-500 bg-clip-text text-transparent">Login</Button></Link>
  <span className='text-primary text-xl'>|</span>
<Link href="/sign-up"><Button variant={"ghost"} className="sm:text-sm  bg-gradient-to-r from-blue-900  to-blue-500 bg-clip-text text-transparent">Signup</Button></Link>
